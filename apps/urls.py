...
from apps.views import RegisterCreateAPIView, user_profile_api_view, PostsListAPIView, PostDetailRetrieveAPIView, \
    ...
    power_unit_api_view, CPUAddCreateAPIView
...
#     Changes
    ...
    path('motherboards/<int:cpu_id>/',MotherBoardListAPIView.as_view()),
    path('others/<int:category_id>/',OtherListAPIView.as_view()),
